/**
 * Industries hub + leaf pages (/industries, /industries/[slug]). Copy mirrored
 * from the reference site and expanded with detail: hero, the challenges we
 * solve, an overview, key benefits, common use cases, and FAQs. One closing
 * CTA (de-duplicated per the audit).
 */
...
export const INDUSTRIES: IndustryLeaf[] = [
  {
    ...
    tagline: "Close more deals with intelligent automation",
    description:
      "Transform property inquiries into qualified leads with AI-powered chatbots that handle viewings, pricing questions, and follow-ups 24/7.",
    overview:
  ...
  },
  {
    ...
    num: "02",
    name: "Healthcare",
    title: "Enhance patient care with smart communication",
    tagline: "Enhance patient care with smart communication",
    description:
      "Streamline patient communication, reduce no-shows, and automate routine tasks while maintaining HIPAA compliance.",
    overview:
  ...
  },
  {
    ...
    num: "03",
    name: "E-commerce",
    title: "Scale customer support without scaling costs",
    tagline: "Scale customer support without scaling costs",
    description:
      "Handle thousands of customer inquiries simultaneously with AI that understands your products and can process orders.",
    overview:
  ...
  },
  {
    ...
    num: "04",
    name: "Education",
    title: "Engage students and streamline enrollment",
    tagline: "Engage students and streamline enrollment",
    description:
      "From course inquiries to enrollment support, automate the student journey while providing personalized guidance.",
    overview:
